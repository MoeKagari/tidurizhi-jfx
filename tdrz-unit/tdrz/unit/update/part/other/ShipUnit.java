...
public class ShipUnit extends Unit<ShipUnitHandler> {
	public final Map<Integer, ShipDto> shipMap = new HashMap<>();
	...
	public void accept(UnitManager unitManager, ShipUnitHandler unitHandler) {
		...
		//加锁
		FunctionUtils.notNull(unitHandler.getShipLock(), sl -> {
	...
	public static interface ShipUnitHandler {
		...
		public default List<ShipDto> getAddShipList() {
		...
		public default ShipLock getShipLock() {
			return null;
		}
	}
	...
	public static class ShipLock {
		...
		public ShipLock(int api_ship_id, boolean api_locked) {
