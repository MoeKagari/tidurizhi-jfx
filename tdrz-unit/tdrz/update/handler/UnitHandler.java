...
import tdrz.update.unit.main.KaisouUnit.KaisouUnitHandler;
import tdrz.update.unit.main.KdockUnit.KdockUnitHandler;
import tdrz.update.unit.main.MissionUnit.MissionUnitHandler;
import tdrz.update.unit.main.NdockUnit.NdockUnitHandler;
import tdrz.update.unit.main.PracticeUnit.PracticeUnitHandler;
import tdrz.update.unit.main.QuestUnit.QuestUnitHandler;
import tdrz.update.unit.main.RemodelUnit.RemodelUnitHandler;
import tdrz.update.unit.other.AkashiUnit.AkashiUnitHandler;
...
import tdrz.update.unit.other.SlotItemUnit.SlotItemUnitHandler;
...
public abstract class UnitHandler implements WordUnitHandler, MemoryUnitHandler, QuestUnitHandler, BattleUnitHandler,
	...
	public List<PrintItem> getPrintItem() {
		return FunctionUtils.asList(new PrintItem(0, null) {
			@Override
	...
	private static final UnitHandler EMPTY_HANDLER = new UnitHandler() {
		@Override
		public boolean haveAnyUpdate() {
			return false;
		}
