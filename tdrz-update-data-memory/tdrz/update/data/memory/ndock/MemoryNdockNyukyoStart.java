...
public class MemoryNdockNyukyoStart extends MemoryNdock {
	private static final long serialVersionUID = 1L;
	private final long time;
	private final MemoryObjShip nyukyoedShip;
	private final int[] oldMaterial, newMaterial;

	public MemoryNdockNyukyoStart(long time, MemoryObjShip nyukyoedShip, int[] oldMaterial, int[] newMaterial) {
		this.time = time;
