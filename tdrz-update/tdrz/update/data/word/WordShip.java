 ...
 * @author MoeKagari
 */
public class WordShip extends AbstractWord {
	...
	private WordMasterShip masterData;

	public WordShip(JsonObject json) {
		...
		this.masterData = MasterDataTranslator.getMasterShipDto(this.shipId);
	}

	public WordMasterShip getMasterData() {
	...
	public void nyukyoEnd() {
		...
		this.ndockTime = 0;
		this.needForPLUpdate = false;//入渠完毕,非自然恢复,更新(PLTIME)时,不需要此ship
	}
