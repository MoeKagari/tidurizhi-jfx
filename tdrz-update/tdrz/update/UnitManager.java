...
public class UnitManager {
	...
	public WordDeck getDeck(int index) {
		return this.deckUnit.deckHolders[index].getDeck();
	}
	public DeckHolder[] getDeckHolders() {
		return this.deckUnit.deckHolders;
	}



	private final UnitKdock kdockUnit = new UnitKdock();
	public WordKdock getKdock(int index) {
		return this.kdockUnit.kdockHolders[index].getKdock();
	}
	public KdockHolder[] getKdockHolders() {
		return this.kdockUnit.kdockHolders;
	}



	private final UnitNdock ndockUnit = new UnitNdock();
	public WordNdock getNdock(int index) {
		return this.ndockUnit.ndockHodlers[index].getNdock();
	}
	public NdockHodler[] getNdockHodlers() {
		return this.ndockUnit.ndockHodlers;
	}
	...
	public WordShip getShip(int id) {
		return this.propertyUnit.shipMap.get(id);
	}
	public Collection<WordShip> getShips() {
		return this.propertyUnit.shipMap.values();
	}
	public WordShip getSecretaryShip() {
		return Optional.ofNullable(this.getDeck(0)).map(deck -> this.getShip(deck.getShipArray()[0])).orElse(null);
	}
	public WordSlotItem getSlotItem(int id) {
		return this.propertyUnit.slotItemMap.get(id);
	}
	public Collection<WordSlotItem> getSlotItems() {
		return this.propertyUnit.slotItemMap.values();
	}	
	public WordUseItem getUseItem(int id) {
		return this.propertyUnit.useItemMap.get(id);
	}
	public Collection<WordUseItem> getUseItems() {
		return this.propertyUnit.useItemMap.values();
	}
	...
	public WordMasterData getMasterData() {
		return this.wordUnit.getMasterData();
	}
	public WordBasic getBasicInformation() {
		return this.wordUnit.getBasicInformation();
	}
	public WordMapinfo getMapInfo() {
		return this.wordUnit.getMapInfo();
	}
	public WordPracticeEnemy getPracticeEnemy() {
		return this.wordUnit.getPracticeEnemy();
	}
	public Integer getCombined() {
		return this.wordUnit.getCombined();
	}
	public WordRecord getRecord() {
		return this.wordUnit.getRecord();
	}

	
	
	private final UnitQuest questUnit = new UnitQuest();
	public List<WordQuest> getQuests() {
		return this.questUnit.quests;
	}
	...
	public WordMaterial getCurrentMaterial() {
		return this.materialUnit.getCurrentMaterial();
	}



	private final UnitMemory memoryUnit = new UnitMemory();
	public List<MemoryBattle> getMemoryBattleList() {
		return this.memoryUnit.memoryBattleList;
	}
	public List<MemoryMission> getMemoryMissionList() {
		return this.memoryUnit.memoryMissionList;
	}
	public List<MemoryOther> getMemoryOtherList() {
		return this.memoryUnit.memoryOtherList;
	}
	public List<MemoryShip> getMemoryShipList() {
		return this.memoryUnit. memoryShipList;
	}
	public List<MemorySlotItem> getMemorySlotItemList() {
		return this.memoryUnit.memorySlotItemList;
	}


	private final UnitAkashi akashiUnit = new UnitAkashi();
	public long getAkashiRepairStartTime() {
		return this.akashiUnit.getTime();
	}
