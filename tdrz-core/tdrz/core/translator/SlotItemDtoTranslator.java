...
public class SlotItemDtoTranslator {
	...
	public static class ItemDataMap {
		...
		public static void main(String[] args) {
			FunctionUtils.notNull(UnitManager.getUnitManager().wordUnit.getMasterData(), md -> {
