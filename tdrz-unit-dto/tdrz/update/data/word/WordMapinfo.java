 ...
 * @author MoeKagari
 */
public class WordMapinfo extends AbstractWord {
	private final List<OneMapInfo> maps;

	public WordMapinfo(JsonArray array) {
		this.maps = array.getValuesAs(JsonObject.class).stream().map(OneMapInfo::new).collect(Collectors.toList());
	}

	public List<OneMapInfo> getMaps() {
		return this.maps;
	}
	...
	public class OneMapInfo {
		...
		public OneMapInfo(JsonObject json) {
