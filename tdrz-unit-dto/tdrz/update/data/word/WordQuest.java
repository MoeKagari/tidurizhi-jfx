...
public class WordQuest extends AbstractWord {
	...
	private final WordQuestInformation information;

	public WordQuest(int page, int no, JsonObject json) {
		this.page = page;
		this.no = no;
		this.information = new WordQuestInformation(json);
	}
	...
	public WordQuestInformation getInformation() {
		return this.information;
	}

	public class WordQuestInformation {
		private final JsonObject json;

		public WordQuestInformation(JsonObject json) {
			this.json = json;
		}
